...
class TopBannerPluginSecond
{
 ...
 /**
   ...
   * @param string $getDummy
   * @return array
   */
   public function beforeGetDummy(TopBanner $subject, string $dummyText): array
   {
       $this->logger->info('PLUGIN: SO-100 beforeGetDummy execution');
       $dummyText .= ', SO-100 before plugin executed';
       return [$dummyText];
   }
   ...
   {
       $this->logger->info('PLUGIN: SO-100 afterGetDummy execution');
       return $result . ', SO-100 after plugin executed';
   }
   ...
   {
       $this->logger->info('PLUGIN: SO-100 aroundGetDummy execution - before proceed');
       $dummyText .= ', SO-100 around plugin before proceed';


       $result = $proceed($dummyText);


       $this->logger->info('PLUGIN: SO-100 aroundGetDummy execution - after proceed');
       return $result . ', SO-100 around plugin after proceed';
   }
}
